...
public class FavoritesOperations {
   ...
   public void addSongFav(SongsList songsList){
        ...
        database.insertWithOnConflict(FavoritesDBHandler.TABLE_SONGS,null,
   ...
   public void removeSong(String songPath){
        ...
        open();
        String wherClause = FavoritesDBHandler.COLUMN_PATH + "=?";
        String[] whereArgs = new String[]{songPath};

        database.delete(FavoritesDBHandler.TABLE_SONGS,wherClause,whereArgs);
